---
marp: true
title: Распараллеливание массовых вычислений
...
- Большая и однородная память.
  - Из любой части программы можно в любой момент "протянуть руку"
    к любому месту памяти.
...
- Каждый проход внутреннего цикла зависит от того, что
